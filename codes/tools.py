...
# =============================================================================
# retriever = handsets_vectorstore.as_retriever()
# handsets_retriever_tool = create_retriever_tool(
#     retriever,
#     "retrieve_phones",
#     "Search and return all handphones asked by customer",
# )
# =============================================================================
...
def go_checkout (input_str: str) -> str:
    ...
    SystemMessage(content="""Determine if customer shows interest in the phone model recommended.
                  ...
                  mentions the phone model they want.  If so, give the URL of 
                  the phone model on https://shop.singtel.com/
                  """),
