...
from codes.tools import guardrail_tool, recommendation_tool, checkout_tool, get_cust_tool, jaibreak_tool
...
tools = [recommendation_tool, checkout_tool, guardrail_tool, get_cust_tool, jaibreak_tool]
...
If customer does not want to provide or you can't retrieve the customer ID, 
tell customer you can't find their data and ask for their phone preferences.
If customer say their phone preferences before providing customer ID, remind 
customer to provide customer ID first.
